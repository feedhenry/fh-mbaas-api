var util = require('util'),
  ...
  fhutils, call, config, widget, cache;
...
var act = function() {
  ...
  function doAppCall(callurl, actParams, reqParams, cb) {
    ...
    if (typeof reqOpts.method === 'string' &&
        reqOpts.method.toLowerCase() === 'get') {
    ...
    async.waterfall([
      ...
      function getHost(host, callback){
        ...
        call("ide/apps/app/hosts", {
          ...
          if ('object' !== typeof res || res.status !== 200) return callback(util.format(ERRORS.AppNotFound, params.guid));
          ...
          cache({"act":"save","value":callurl,"key": hostCacheKey,"expire": 5*60},function(err){
