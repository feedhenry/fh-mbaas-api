...
module.exports = {
  ...
  doList : function(dataset_id, params, cb, meta_data) {
    syncUtil.doLog(dataset_id, 'info', 'doList : ' + dataset_id + ' :: ' + util.inspect(params) + ' :: meta=' + util.inspect(meta_data));
  ...
  doCreate : function(dataset_id, data, cb, meta_data) {
    syncUtil.doLog(dataset_id, 'info', 'doCreate : ' + dataset_id + ' :: ' + util.inspect(data) + ' :: meta=' + util.inspect(meta_data));
  ...
  doRead : function(dataset_id, uid, cb, meta_data) {
    syncUtil.doLog(dataset_id, 'info', 'doRead : ' + dataset_id + ' :: ' + uid + ' :: meta=' + util.inspect(meta_data));
  ...
  doUpdate : function(dataset_id, uid, data, cb, meta_data) {
    syncUtil.doLog(dataset_id, 'info', 'doUpdate : ' + dataset_id + ' :: ' + uid + ' :: ' + util.inspect(data) + ' :: meta=' + util.inspect(meta_data));
  ...
  doDelete : function(dataset_id, uid, cb, meta_data) {
    syncUtil.doLog(dataset_id, 'info', 'doDelete : ' + dataset_id + ' :: ' + uid + ' :: meta=' + util.inspect(meta_data));
  ...
  doCollision : function(dataset_id, hash, timestamp, uid, pre, post, meta_data) {
    syncUtil.doLog(dataset_id, 'info', 'doCollision : ' + dataset_id + ' :: hash=' + hash + ' :: timestamp=' + timestamp + ' :: uid=' + uid + ' :: pre=' + util.inspect(pre) + ' :: post=' + util.inspect(post) + ' :: meta=' + util.inspect(meta_data));
  ...
  listCollisions : function(dataset_id, cb, meta_data) {
    syncUtil.doLog(dataset_id, 'info', 'listCollisions : ' + dataset_id + ' :: meta=' + util.inspect(meta_data));
    $fh.db({
      "act": "list",
      "type": dataset_id + '_collision'
    }, function(err, res) {
  ...
  removeCollision : function(dataset_id, hash, cb, meta_data) {
    syncUtil.doLog(dataset_id, 'info', 'removeCollision : ' + dataset_id + ' :: hash=' + hash + ' :: meta=' + util.inspect(meta_data));
    $fh.db({
      "act": "list",
      "type": dataset_id + '_collision',
      "eq": {
