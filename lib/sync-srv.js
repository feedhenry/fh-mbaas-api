  ...
  async.forEachSeries(pending, function (pendingObj, itemCallback) {
      ...
      if ("create" === action) {
        ...
        DataSetModel.doReadHandler(dataset_id, uid, function (err, data) {
          ...
          syncUtil.generateHash(pre, function(err, preHash) {
            syncUtil.generateHash(data, function(err, dataHash) {
              ...
              if (preHash === dataHash) {
                ...
                syncUtil.generateHash(post, function(err, postHash) {
