...
function doSyncRecords(dataset_id, params, callback) {
  ...
  DataSetModel.getDatasetClient(dataset_id, params, function(err, datasetClient) {
    ...
    var updateRecords = function(datasetClient, callback){
      ...
      DataSetModel.getDatasetClientRecords(datasetClient, function(err, serverRecs) {
    ...
    if( datasetClient.dataHash) {
      updateRecords(datasetClient, callback);
    } else {
      DataSetModel.syncDatasetClient(datasetClient, function(err, records){
        if(err){
          return callback(err);
        }
        DataSetModel.getDatasetClient(dataset_id, params, function(err, datasetClient){
