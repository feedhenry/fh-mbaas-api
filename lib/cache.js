...
redisPort = process.env.FH_REDIS_PORT || process.env.OPENSHIFT_REDIS_PORT || 6379,
redisHost = process.env.FH_REDIS_HOST || process.env.OPENSHIFT_REDIS_HOST || '127.0.0.1',
redisPassword = process.env.FH_REDIS_PASSWORD || process.env.REDIS_PASSWORD || '',
