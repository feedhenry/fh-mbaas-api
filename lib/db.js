...
if (process.env.OPENSHIFT_MONGODB_DB_HOST || process.env.MONGODB_SERVICE_HOST){
  ...
  openshiftConnectionString = openshiftConnectionString.replace('<user>', user);
  openshiftConnectionString = openshiftConnectionString.replace('<pass>', pass);
  openshiftConnectionString = openshiftConnectionString.replace('<host>', host);
  openshiftConnectionString = openshiftConnectionString.replace('<port>', port);
  openshiftConnectionString = openshiftConnectionString.replace('<db>', dbname);
