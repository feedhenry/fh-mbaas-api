...
var submitFormFile = function(options, cb){
  ...
  if(!typeof submissionOptions.fileStream === "string"){
  ...
  fs.stat(filePath, function(err, stats){
    ...
    if(submissionOptions.decodeBase64){
      mbaasClient.app.submissions.uploadFileBase64(fileRequestParams, cb);
    } else {
      mbaasClient.app.submissions.uploadFile(fileRequestParams, cb);
    }
  });
