...
function createServerSettings( url, applicationId, masterSecret, header ) {
    var headers = Object.create(header);
...
AeroGear.Sender.prototype.send = function( message, options, callback ) {
    ...
    serverSettings = createServerSettings( url, this.getApplicationId(), this.getMasterSecret(), this.getHeader() );
