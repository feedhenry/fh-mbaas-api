...
function createServerSettings( url, applicationId, masterSecret, additionalHeaders ) {
    var headers = {};
    headers["Accept"] = "application/json";
    headers["Content-type"] = "application/json";
    headers["aerogear-sender"] = "AeroGear Node.js Sender";
...
AeroGear.Sender = function( settings ) {
    ...
    if( !settings.url || !settings.applicationId || !settings.masterSecret ) {
        throw new Error("UnifiedPushSenderError");
    }
...
AeroGear.Sender.prototype.send = function( message, options, callback ) {
    ...
    serverSettings = createServerSettings( url, this.getApplicationId(), this.getMasterSecret(), this.getHeaders() );
