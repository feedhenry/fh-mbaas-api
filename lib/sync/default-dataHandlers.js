...
module.exports = function(db) {
  ...
  return {
    ...
    countCollisions: function(dataset_id, meta_data, cb) {
      debug('[%s] countCollisions :: hash=%s :: meta=%j', dataset_id, meta_data);
      mongo.collection(collisionCollection(dataset_id)).count({}, cb);
    }
