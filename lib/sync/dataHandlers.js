...
module.exports = function(options) {
  ...
  var names = {
    ...
    COUNT_COLLISIONS: 'countCollisionsHandler'
  }
  var handlers;
  var globalHandlers;
  ...
  function initHandlers() {
    ...
    globalHandlers = {
      ...
      countCollisionsHandler: options.defaultHandlers.countCollisions
    }
  }
  ...
  return {
   ...
   /**
     ...
     * @param callback
     */
    countCollisions: function(datasetId, metaData, callback) {
      var handler = handlerFor(datasetId, names.COUNT_COLLISIONS);
      handler(datasetId, metaData, callback);
    },
